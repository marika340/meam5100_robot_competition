...
private:
  ...
  float _frontStopDist    = 280.0f;  // increased so robot starts turning sooner, wall attack: 280, original: 300
  float _wallLostDist     = 600.0f;
  float _turnClearDist    = 285.0f; // MUST stay > _frontStopDist or handleCorner() pivot loop never runs, wall attack: 285, original: 300
